    ...
    <header className="sticky top-0 z-50 border-b border-white/[0.08] bg-ink/80 backdrop-blur-xl transition-colors">
      <div className="mx-auto flex h-[var(--header-height)] max-w-7xl items-center justify-between px-5 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-2 lg:flex" aria-label="Main navigation">
          ...
          >
            <button
              type="button" className="focus-ring inline-flex items-center gap-1 rounded-md px-3 py-2 text-[15px] font-medium text-steel transition hover:text-white"
            >
              Products
        ...
        <div className="hidden lg:block">
          <a
            href="https://www.mql5.com/en/market/product/183557" className="focus-ring inline-flex min-h-11 items-center justify-center gap-2 rounded-lg px-5 py-3 text-sm font-semibold transition bg-brand-gradient text-[#05070d] shadow-glow hover:brightness-110 active:scale-95"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <div className="lg:hidden border-t border-white/[0.08] bg-ink/95 px-6 py-6 backdrop-blur-2xl space-y-3">
          ...
          <div className="pt-4 border-t border-white/[0.08]">
            <a
              ...
              target="_blank"
              rel="noreferrer" className="flex w-full items-center justify-center gap-2 rounded-lg bg-brand-gradient py-3 text-sm font-semibold text-[#05070d]"
            >
              <span>Buy on MQL5</span>
              <ExternalLink className="h-4 w-4" />
            </a>
